...
**Data Scientist | AI Specialist | OpenClaw Contributor**
...
Active contributor to OpenClaw, the open-source AI agent framework with 194k+ stars. Working on skill system improvements and bug fixes.

### [ClawHub Skills](https://clawhub.ai)
Published AI agent skills: **sports-odds**, **nft-tracker**, **data-viz**, and **screenshot-annotator** (using Peekaboo for macOS UI automation).

### [Money Maker Bot](https://github.com/ianalloway/Money-maker-bot)
Financial intelligence assistant built on OpenClaw. Fork it to build your own AI trading assistant with sports betting analysis, NFT tracking, and portfolio visualization.
